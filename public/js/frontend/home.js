...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-d02cff62", module.exports)
  } else {
...
exports.default = {
    ...
    vuex: {
        getters: {
            questions: _getters.getQuestions,
            questionMarks: _getters.getQuestionMarks
        },
        actions: {
            init: _actions.init
        }
...
var getQuestionMarks = exports.getQuestionMarks = function getQuestionMarks(state) {
