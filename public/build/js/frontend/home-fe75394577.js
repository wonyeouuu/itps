...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div class=\"question-container\" _v-4ac01936=\"\">\n    <h1 _v-4ac01936=\"\">\n        {{ number }}. {{ title }}\n        <span class=\"table-trigger\" :class=\"{ 'table-trigger--selected': tableShow }\" @click=\"tableShowToggle(number)\" _v-4ac01936=\"\"></span>\n    </h1>\n    <div class=\"table-normal\" v-show=\"tableShow\" _v-4ac01936=\"\">\n        <div class=\"row-top teeth-row\" _v-4ac01936=\"\">\n            <div class=\"row-top-left col-xs-6 rtl\" _v-4ac01936=\"\">\n                <div v-for=\"tooth in teeth.slice(0,8)\" class=\"circle\" v-bind:class=\"{ 'circle--selected': tooth.selected }\" @click=\"teethToggle(number, tooth.id, !tooth.selected)\" v-show=\"tooth.selectable\" _v-4ac01936=\"\">{{ tooth.id }}</div>\n            </div>\n            <div class=\"row-top-right col-xs-6 ltr\" _v-4ac01936=\"\">\n                <div v-for=\"tooth in teeth.slice(8,16)\" class=\"circle\" v-bind:class=\"{ 'circle--selected': tooth.selected }\" @click=\"teethToggle(number, tooth.id, !tooth.selected)\" v-show=\"tooth.selectable\" _v-4ac01936=\"\">{{ tooth.id }}</div>\n            </div>\n        </div>\n        <div class=\"row-bottom teeth-row\" _v-4ac01936=\"\">\n            <div class=\"row-bottom-left col-xs-6 rtl\" _v-4ac01936=\"\">\n                <div v-for=\"tooth in teeth.slice(16,24)\" class=\"circle\" v-bind:class=\"{ 'circle--selected': tooth.selected }\" @click=\"teethToggle(number, tooth.id, !tooth.selected)\" v-show=\"tooth.selectable\" _v-4ac01936=\"\">{{ tooth.id }}</div>\n            </div>\n            <div class=\"row-bottom-right col-xs-6 ltr\" _v-4ac01936=\"\">\n                <div v-for=\"tooth in teeth.slice(24,32)\" class=\"circle\" v-bind:class=\"{ 'circle--selected': tooth.selected }\" @click=\"teethToggle(number, tooth.id, !tooth.selected)\" v-show=\"tooth.selectable\" _v-4ac01936=\"\">{{ tooth.id }}</div>\n            </div>\n        </div>\n    </div>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
...
function teethArr4() {
    ...
    var a = [35, 33, 31, 29, 27, 25, 23, 32, 43, 45, 47, 49, 51, 53, 55, 95, 93, 91, 89, 87, 85, 83, 72, 63, 65, 67, 69, 71, 73, 75];
