...
div.container.questionListContainer
    div.export-graph
        ...
        div.row-down.row
            ...
            div.row--ltr
                img.t31(src='/imgs/teeth/41/01.png')
                img.t32(src='/imgs/teeth/42/01.png')
                img.t33(src='/imgs/teeth/43/01.png')
                img.t34(src='/imgs/teeth/44/01.png')
                img.t35(src='/imgs/teeth/45/01.png')
                img.t36(src='/imgs/teeth/46/01.png')
                img.t37(src='/imgs/teeth/47/01.png')
                img.t38(src='/imgs/teeth/48/01.png')
